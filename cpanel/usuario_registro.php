                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="img/usuarios/noimagen.jpg" class="img-circle" alt="User Image" />
                                    <p>
                                        <?php //echo $s_nombre ?>
                                ...
                                <form action="usuario_registro_insertar.php" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Id Partido" name="nombre" maxlength="100" required/>
                                        </div>
                                    </div><!-- /.box-body -->
									<div class='box'>
										<div class='box-header'>
