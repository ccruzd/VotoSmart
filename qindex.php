        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right service-nav">
                <li><a id="dropdownMenuCart"  href="qindex.php" class="dropdown-toggle"><img src="img/espanol.png" width="36px"/>&nbsp;<span class="badge">Español</span></a>
              </li>
            </ul>
              ...
              <div class="section-title">
				...
				<?php
					...
					<div class="accordion-item panel">
						<div class="accordion-heading"><a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $gpselectoral['id'] ?>" class="accordion-toggle"><?php echo $gpselectoral['id'].". ".$gpselectoral['pregunta'] ?><i class="accordion-icon fa <?php if($i==1){ echo "fa-minus";} else{ echo "fa-plus"; }?>"></i></a></div>
