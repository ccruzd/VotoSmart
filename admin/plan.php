                ...
                <section class="content">
                    <script type="text/javascript">
						 function actionadd(){
                                                ...
                                                document.partidos.action="add/addplanes.php";
                        ...
                        <div class='col-md-12'>
                            ...
                            <form action="" method="post" name="partidos">
                                ...
                                <div class='box-body pad'>                                    
                                        <textarea class="textarea" name="plan" placeholder="Plan de Gobierno" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>           
                                </div>
