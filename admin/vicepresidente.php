            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <script type="text/javascript">
						 function actionadd(){                     
                                                document.partidos.action="add/addvice.php";
                        ...
                        <div class='col-md-12'>
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="partidos">
                                        <?php 
                                        $mysqli = new mysqli("localhost", "root", "", "voto");
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select name="cargo">
                                        ...
                                        <option value="1">Primer Vicepresidente</option>
                                        <option value="2">Segundo Vicepresidente</option>
                                    </select>
                                  </div>
                                        <div class="form-group">
