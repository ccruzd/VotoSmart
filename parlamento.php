    ...
    <div class="page">
      ...
      <section style="background-image: url('img/intro-home9.jpg');" class="header-section fading-title parallax">
        <div class="section-shade sep-top-3x sep-bottom-2x">
          <div class="section-title text-upper text-center upper light">
			<img src="http://votoinformado.pe/voto/img/imgTitParlAndino.png" />
            <h2 class="small-space">Parlamento <span class="text-primary">Andino</span></h2>
          </div>
        </div>
      </section>
	  <!-- End header Section ------------------------------------------------------------------------->
     <!-- Start About section-->
      <section id="presidente" class="sep-bottom-2x">
        <div class="container">
			<div class="row">
				<div class="col-md-10 col-md-offset-1 sep-top-2x text-center">
